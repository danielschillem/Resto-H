...
return new class extends Migration {
    ...
    {
        // Changer la colonne role de enum vers string (compatible SQLite & PostgreSQL)
        ...
        if ($driver === 'sqlite') {
            ...
            // PostgreSQL / MySQL : modifier la colonne directement
        ...
        $defaults = [
            'prestataire' => ['dashboard','menus','commandes','commandes.livrer','regimes'],
