    ...
    <div style={{ maxWidth: 680 }}>
      ...
      >
        ...
        >
          ...
          <div
            style={{
              background:
                licence && licence.jours_restants <= 3
                  ? "#FEE2E2"
                  : licence && licence.jours_restants <= 7
                    ? "#FEF3C7"
                    : "var(--bg)",
              borderRadius: 8,
              padding: "14px 16px",
        ...
        {licence?.statut === "essai" && (
          ...
          >
            <i
              ...
              style={{ marginRight: 8 }}
            />
            Vous êtes en période d&apos;essai. Activez une licence premium pour
            un accès illimité.
          </div>
        )}
        {licence?.statut === "expire" && (
          ...
          >
            ...
            Votre licence a expiré. Veuillez activer une nouvelle licence pour
            continuer.
          </div>
        )}
      </div>
      ...
      {canActivate && (
        ...
        >
          ...
          <p
            style={{ fontSize: 13, color: "var(--text-sm)", marginBottom: 20 }}
          >
            Abonnement annuel. Format de clé :{" "}
            <code
              style={{
                background: "var(--bg)",
                padding: "2px 6px",
      ...
      <div
        style={{
          marginTop: 20,
          background: "linear-gradient(135deg, #1B2E4B, #0f4c81)",
          borderRadius: 12,
          padding: 24,
          color: "white",
        }}
